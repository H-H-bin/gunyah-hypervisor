...
void
wait_queue_prepare(wait_queue_t *wait_queue) ACQUIRE_PREEMPT_DISABLED
ACQUIRE_LOCK(wait_queue);
...
void
wait_queue_get(void) REQUIRE_PREEMPT_DISABLED
ACQUIRE_LOCK(wait_queue_condition);
...
void
wait_queue_put(void) REQUIRE_PREEMPT_DISABLED
RELEASE_LOCK(wait_queue_condition);
...
void
wait_queue_wait(void) REQUIRE_PREEMPT_DISABLED
RELEASE_LOCK(wait_queue_condition);
...
void
wait_queue_finish(wait_queue_t *wait_queue) RELEASE_PREEMPT_DISABLED
RELEASE_LOCK(wait_queue) EXCLUDE_LOCK(wait_queue_condition);
