...
sysreg_write_cpu(ESR_EL2_ISS_MSR_MRS_t iss)
{
	...
	case ISS_MRS_MSR_CPUACTLR2_EL1:
	case ISS_MRS_MSR_CPUACTLR3_EL1:
	case ISS_MRS_MSR_CPUACTLR4_EL1:
	case ISS_MRS_MSR_CPUACTLR5_EL1:
	case ISS_MRS_MSR_CPUACTLR6_EL1:
	case ISS_MRS_MSR_CPUECTLR_EL1:
	case ISS_MRS_MSR_CPUECTLR2_EL1:
